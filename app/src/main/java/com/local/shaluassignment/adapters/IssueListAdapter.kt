...
class IssueListAdapter(
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.itemView.tvIssueDescription.text = "Issue Description : " + issueItem.issueDescription
        ...
        holder.itemView.btnIssueComments.setOnClickListener {
            clickListener.commentListEvent(issueItem.commentsUrl.toString())
        }
    }
    ...
    interface BtnClickListener {
        fun commentListEvent(commentUrl: String)
    }
}
